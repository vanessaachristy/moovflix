                    ...
                    <div class="input-field">
                        <form action="" method="post" id="userForm" onsubmit="return validateForm()">
                            <div class="form-group">
                                ...
                                <input class="input-fields <?php if ($signupFailed) echo 'error-border'; ?>" id="userName" type="name" name="name" placeholder="Enter your name here" required size="30" oninput="validateName()">
                                <div class="error" id="invalidName">Please enter a valid name.</div>
                            </div>
                            <div class="form-group">
                                <label class="fields-title">E-Mail</label>
                                <input class="input-fields <?php if ($signupFailed) echo 'error-border'; ?>" type="text" id="userEmail" name="email" placeholder="Enter your email here" required size="30" oninput="validateEmail(); checkEmailAvailability();">
                                <div class="error" id="invalidEmail">Please enter a valid email address.</div>
                            </div>
                            <div class="form-group">
                                <label class="fields-title">Password</label>
                                <input class="input-fields <?php if ($signupFailed) echo 'error-border'; ?>" id="userPassword" type="password" name="password" placeholder="Enter your password here" required size="30">
                            </div>
                            <div class="form-group">
                                <label class="fields-title">Confirm Password</label>
                                <input class="input-fields <?php if ($signupFailed) echo 'error-border'; ?>" id="confirmPassword" type="password" name="password" placeholder="Confirm your password here" required size="30" oninput="validateConfirmPassword()">
                        ...
                        <h3>Already have an account? <span class="sign-up-link"><a href="login.php">Log In</a></span></h3>
                    </div>
                </div>
        </section>
